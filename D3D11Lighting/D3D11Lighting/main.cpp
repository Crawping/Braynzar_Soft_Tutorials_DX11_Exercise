...
void UpdateScene(double time)
{
    ...
    //Exercise:Make the Light spin around your scene, like the sun.
    lr += 5.0f * time;
    if (lr > 6.28f)
        lr = 0.0f;
    light.dir = XMFLOAT3(1.25f, 1.0f, -1.0f);
    XMVECTOR l = XMVectorSet(light.dir.x, light.dir.y, light.dir.z,0);
    XMVECTOR v = XMVector3Transform(l, XMMatrixRotationAxis(rotaxis, lr));
 ...
 //   XMMATRIX m = XMVectorSet(light.dir.x, light.dir.y, light.dir.z, 0);
