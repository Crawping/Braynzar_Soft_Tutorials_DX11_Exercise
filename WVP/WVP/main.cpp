...
bool InitScene()
{
	...
	//Camera information
    //Exercise: Change the cameras position.
	camPosition = XMVectorSet( 0.5f, 0.5f, -1.7f, 0.0f );
...
void DrawScene()
{
    ...
    //Exercise: Add another variable to the constant buffer which will update the pixels color.
    cbPerObj.PCOLOR = XMFLOAT4(0.5f, 0.1f, 0.2f, 1.0f);
	cbPerObj.WVP = XMMatrixTranspose(WVP);	

	d3d11DevCon->UpdateSubresource( cbPerObjectBuffer, 0, NULL, &cbPerObj, 0, 0 );

	d3d11DevCon->VSSetConstantBuffers( 0, 1, &cbPerObjectBuffer );
    //Set PixelShader ConstantBuffers
